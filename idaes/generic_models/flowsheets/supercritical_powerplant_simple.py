...
def pfd_result(outfile, m):
    ...
    tags['power_out'] = ("%4.4f" % pyo.value(m.fs.plant_power_out[0]))
    
    ## Boiler
    tags['boiler_Fin'] = ("%4.4f" % (pyo.value(m.fs.boiler.inlet.flow_mol[0])*1e-3))
    tags['boiler_Tin'] = ("%4.4f" % (pyo.value(m.fs.boiler.control_volume.properties_in[0].temperature)))
    tags['boiler_Pin'] = ("%4.4f" % (pyo.value(m.fs.boiler.inlet.pressure[0])*1e-6))
    tags['boiler_Hin'] = ("%4.2f" % (pyo.value(m.fs.boiler.inlet.enth_mol[0])))
    tags['boiler_xin'] = ("%4.4f" % (pyo.value(m.fs.boiler.control_volume.properties_in[0].vapor_frac)))
    tags['boiler_Fout'] = ("%4.4f" % (pyo.value(m.fs.boiler.outlet.flow_mol[0])*1e-3))
    tags['boiler_Tout'] = ("%4.4f" % (pyo.value(m.fs.boiler.control_volume.properties_out[0].temperature)))
    tags['boiler_Pout'] = ("%4.4f" % (pyo.value(m.fs.boiler.outlet.pressure[0])*1e-6))
    tags['boiler_Hout'] = ("%4.2f" % (pyo.value(m.fs.boiler.outlet.enth_mol[0])))
    tags['boiler_xout'] = ("%4.4f" % (pyo.value(m.fs.boiler.control_volume.properties_out[0].vapor_frac)))

    # Reheater
    tags['reheat_Fout'] = ("%4.4f" % (pyo.value(m.fs.reheater.outlet.flow_mol[0])*1e-3))
    tags['reheat_Tout'] = ("%4.4f" % (pyo.value(m.fs.reheater.control_volume.properties_out[0].temperature)))
    tags['reheat_Pout'] = ("%4.4f" % (pyo.value(m.fs.reheater.outlet.pressure[0])*1e-6))
    tags['reheat_Hout'] = ("%4.2f" % (pyo.value(m.fs.reheater.outlet.enth_mol[0])))
    tags['reheat_xout'] = ("%4.4f" % (pyo.value(m.fs.reheater.control_volume.properties_out[0].vapor_frac)))

    # BFPT
    tags['bfpt_Fin'] = ("%4.4f" % (pyo.value(m.fs.bfpt.inlet.flow_mol[0])*1e-3))
    tags['bfpt_Tin'] = ("%4.4f" % (pyo.value(m.fs.bfpt.control_volume.properties_in[0].temperature)))
    tags['bfpt_Pin'] = ("%4.4f" % (pyo.value(m.fs.bfpt.inlet.pressure[0])*1e-6))
    tags['bfpt_Hin'] = ("%4.2f" % (pyo.value(m.fs.bfpt.inlet.enth_mol[0])))
    tags['bfpt_xin'] = ("%4.4f" % (pyo.value(m.fs.bfpt.control_volume.properties_in[0].vapor_frac)))
    tags['bfpt_Fout'] = ("%4.4f" % (pyo.value(m.fs.bfpt.outlet.flow_mol[0])*1e-3))
    tags['bfpt_Tout'] = ("%4.4f" % (pyo.value(m.fs.bfpt.control_volume.properties_out[0].temperature)))
    tags['bfpt_Pout'] = ("%4.4f" % (pyo.value(m.fs.bfpt.outlet.pressure[0])*1e-6))
    tags['bfpt_Hout'] = ("%4.2f" % (pyo.value(m.fs.bfpt.outlet.enth_mol[0])))
    tags['bfpt_xout'] = ("%4.4f" % (pyo.value(m.fs.bfpt.control_volume.properties_out[0].vapor_frac)))

    ## Condenser
    tags['cond_Fin'] = ("%4.4f" % (pyo.value(m.fs.condenser.inlet.flow_mol[0])*1e-3))
    tags['cond_Tin'] = ("%4.4f" % (pyo.value(m.fs.condenser.control_volume.properties_in[0].temperature)))
    tags['cond_Pin'] = ("%4.4f" % (pyo.value(m.fs.condenser.inlet.pressure[0])*1e-6))
    tags['cond_Hin'] = ("%4.2f" % (pyo.value(m.fs.condenser.inlet.enth_mol[0])))
    tags['cond_xin'] = ("%4.4f" % (pyo.value(m.fs.condenser.control_volume.properties_in[0].vapor_frac)))
    tags['cond_Fout'] = ("%4.4f" % (pyo.value(m.fs.condenser.outlet.flow_mol[0])*1e-3))
    tags['cond_Tout'] = ("%4.4f" % (pyo.value(m.fs.condenser.control_volume.properties_out[0].temperature)))
    tags['cond_Pout'] = ("%4.4f" % (pyo.value(m.fs.condenser.outlet.pressure[0])*1e-6))
    tags['cond_Hout'] = ("%4.2f" % (pyo.value(m.fs.condenser.outlet.enth_mol[0])))
    tags['cond_xout'] = ("%4.4f" % (pyo.value(m.fs.condenser.control_volume.properties_out[0].vapor_frac)))

    ## Feed water heaters
    tags['fwh1_Fout1'] = ("%4.4f" % (pyo.value(m.fs.fwh1.outlet_1.flow_mol[0])*1e-3))
    tags['fwh1_Tout1'] = ("%4.4f" % (pyo.value(m.fs.fwh1.side_1.properties_out[0].temperature)))
    tags['fwh1_Pout1'] = ("%4.4f" % (pyo.value(m.fs.fwh1.outlet_1.pressure[0])*1e-6))
    tags['fwh1_Hout1'] = ("%4.2f" % (pyo.value(m.fs.fwh1.outlet_1.enth_mol[0])))
    tags['fwh1_xout1'] = ("%4.4f" % (pyo.value(m.fs.fwh1.side_1.properties_out[0].vapor_frac)))

    tags['fwh2_Fout1'] = ("%4.4f" % (pyo.value(m.fs.fwh2.outlet_1.flow_mol[0])*1e-3))
    tags['fwh2_Tout1'] = ("%4.4f" % (pyo.value(m.fs.fwh2.side_1.properties_out[0].temperature)))
    tags['fwh2_Pout1'] = ("%4.4f" % (pyo.value(m.fs.fwh2.outlet_1.pressure[0])*1e-6))
    tags['fwh2_Hout1'] = ("%4.2f" % (pyo.value(m.fs.fwh2.outlet_1.enth_mol[0])))
    tags['fwh2_xout1'] = ("%4.4f" % (pyo.value(m.fs.fwh2.side_1.properties_out[0].vapor_frac)))

    tags['fwh3_Fout1'] = ("%4.4f" % (pyo.value(m.fs.fwh3.outlet_1.flow_mol[0])*1e-3))
    tags['fwh3_Tout1'] = ("%4.4f" % (pyo.value(m.fs.fwh3.side_1.properties_out[0].temperature)))
    tags['fwh3_Pout1'] = ("%4.4f" % (pyo.value(m.fs.fwh3.outlet_1.pressure[0])*1e-6))
    tags['fwh3_Hout1'] = ("%4.2f" % (pyo.value(m.fs.fwh3.outlet_1.enth_mol[0])))
    tags['fwh3_xout1'] = ("%4.4f" % (pyo.value(m.fs.fwh3.side_1.properties_out[0].vapor_frac)))

    tags['fwh4_Fin1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.inlet_1.flow_mol[0])*1e-3))
    tags['fwh4_Tin1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.side_1.properties_in[0].temperature)))
    tags['fwh4_Pin1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.inlet_1.pressure[0])*1e-6))
    tags['fwh4_Hin1'] = ("%4.2f" % (pyo.value(m.fs.fwh4.inlet_1.enth_mol[0])))
    tags['fwh4_xin1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.side_1.properties_in[0].vapor_frac)))
    tags['fwh4_Fout1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.outlet_1.flow_mol[0])*1e-3))
    tags['fwh4_Tout1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.side_1.properties_out[0].temperature)))
    tags['fwh4_Pout1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.outlet_1.pressure[0])*1e-6))
    tags['fwh4_Hout1'] = ("%4.2f" % (pyo.value(m.fs.fwh4.outlet_1.enth_mol[0])))
    tags['fwh4_xout1'] = ("%4.4f" % (pyo.value(m.fs.fwh4.side_1.properties_out[0].vapor_frac)))

    tags['fwh6_Fout1'] = ("%4.4f" % (pyo.value(m.fs.fwh6.outlet_1.flow_mol[0])*1e-3))
    tags['fwh6_Tout1'] = ("%4.4f" % (pyo.value(m.fs.fwh6.side_1.properties_out[0].temperature)))
    tags['fwh6_Pout1'] = ("%4.4f" % (pyo.value(m.fs.fwh6.outlet_1.pressure[0])*1e-6))
    tags['fwh6_Hout1'] = ("%4.2f" % (pyo.value(m.fs.fwh6.outlet_1.enth_mol[0])))
    tags['fwh6_xout1'] = ("%4.4f" % (pyo.value(m.fs.fwh6.side_1.properties_out[0].vapor_frac)))

    tags['fwh7_Fout1'] = ("%4.4f" % (pyo.value(m.fs.fwh7.outlet_1.flow_mol[0])*1e-3))
    tags['fwh7_Tout1'] = ("%4.4f" % (pyo.value(m.fs.fwh7.side_1.properties_out[0].temperature)))
    tags['fwh7_Pout1'] = ("%4.4f" % (pyo.value(m.fs.fwh7.outlet_1.pressure[0])*1e-6))
    tags['fwh7_Hout1'] = ("%4.2f" % (pyo.value(m.fs.fwh7.outlet_1.enth_mol[0])))
    tags['fwh7_xout1'] = ("%4.4f" % (pyo.value(m.fs.fwh7.side_1.properties_out[0].vapor_frac)))

    tags['fwh8_Fin1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.inlet_1.flow_mol[0])*1e-3))
    tags['fwh8_Tin1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.side_1.properties_in[0].temperature)))
    tags['fwh8_Pin1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.inlet_1.pressure[0])*1e-6))
    tags['fwh8_Hin1'] = ("%4.2f" % (pyo.value(m.fs.fwh8.inlet_1.enth_mol[0])))
    tags['fwh8_xin1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.side_1.properties_in[0].vapor_frac)))
    tags['fwh8_Fout1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.outlet_1.flow_mol[0])*1e-3))
    tags['fwh8_Tout1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.side_1.properties_out[0].temperature)))
    tags['fwh8_Pout1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.outlet_1.pressure[0])*1e-6))
    tags['fwh8_Hout1'] = ("%4.2f" % (pyo.value(m.fs.fwh8.outlet_1.enth_mol[0])))
    tags['fwh8_xout1'] = ("%4.4f" % (pyo.value(m.fs.fwh8.side_1.properties_out[0].vapor_frac)))


    ## Feed water heaters mixers
    tags['fwh1mix_steam_Fin'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.steam.flow_mol[0])*1e-3))
    tags['fwh1mix_steam_Tin'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.steam_state[0].temperature)))
    tags['fwh1mix_steam_Pin'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.steam.pressure[0])*1e-6))
    tags['fwh1mix_steam_Hin'] = ("%4.2f" % (pyo.value(m.fs.fwh1_mix.steam.enth_mol[0])))
    tags['fwh1mix_steam_xin'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.steam_state[0].vapor_frac)))
    tags['fwh1mix_Fout'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.outlet.flow_mol[0])*1e-3))
    tags['fwh1mix_Tout'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.mixed_state[0].temperature)))
    tags['fwh1mix_Pout'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.outlet.pressure[0])*1e-6))
    tags['fwh1mix_Hout'] = ("%4.2f" % (pyo.value(m.fs.fwh1_mix.outlet.enth_mol[0])))
    tags['fwh1mix_xout'] = ("%4.4f" % (pyo.value(m.fs.fwh1_mix.mixed_state[0].vapor_frac)))

    tags['fwh2mix_steam_Fin'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.steam.flow_mol[0])*1e-3))
    tags['fwh2mix_steam_Tin'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.steam_state[0].temperature)))
    tags['fwh2mix_steam_Pin'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.steam.pressure[0])*1e-6))
    tags['fwh2mix_steam_Hin'] = ("%4.2f" % (pyo.value(m.fs.fwh2_mix.steam.enth_mol[0])))
    tags['fwh2mix_steam_xin'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.steam_state[0].vapor_frac)))
    tags['fwh2mix_Fout'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.outlet.flow_mol[0])*1e-3))
    tags['fwh2mix_Tout'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.mixed_state[0].temperature)))
    tags['fwh2mix_Pout'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.outlet.pressure[0])*1e-6))
    tags['fwh2mix_Hout'] = ("%4.2f" % (pyo.value(m.fs.fwh2_mix.outlet.enth_mol[0])))
    tags['fwh2mix_xout'] = ("%4.4f" % (pyo.value(m.fs.fwh2_mix.mixed_state[0].vapor_frac)))

    tags['fwh3mix_steam_Fin'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.steam.flow_mol[0])*1e-3))
    tags['fwh3mix_steam_Tin'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.steam_state[0].temperature)))
    tags['fwh3mix_steam_Pin'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.steam.pressure[0])*1e-6))
    tags['fwh3mix_steam_Hin'] = ("%4.2f" % (pyo.value(m.fs.fwh3_mix.steam.enth_mol[0])))
    tags['fwh3mix_steam_xin'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.steam_state[0].vapor_frac)))
    tags['fwh3mix_Fout'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.outlet.flow_mol[0])*1e-3))
    tags['fwh3mix_Tout'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.mixed_state[0].temperature)))
    tags['fwh3mix_Pout'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.outlet.pressure[0])*1e-6))
    tags['fwh3mix_Hout'] = ("%4.2f" % (pyo.value(m.fs.fwh3_mix.outlet.enth_mol[0])))
    tags['fwh3mix_xout'] = ("%4.4f" % (pyo.value(m.fs.fwh3_mix.mixed_state[0].vapor_frac)))

    tags['fwh6mix_steam_Fin'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.steam.flow_mol[0])*1e-3))
    tags['fwh6mix_steam_Tin'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.steam_state[0].temperature)))
    tags['fwh6mix_steam_Pin'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.steam.pressure[0])*1e-6))
    tags['fwh6mix_steam_Hin'] = ("%4.2f" % (pyo.value(m.fs.fwh6_mix.steam.enth_mol[0])))
    tags['fwh6mix_steam_xin'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.steam_state[0].vapor_frac)))
    tags['fwh6mix_Fout'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.outlet.flow_mol[0])*1e-3))
    tags['fwh6mix_Tout'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.mixed_state[0].temperature)))
    tags['fwh6mix_Pout'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.outlet.pressure[0])*1e-6))
    tags['fwh6mix_Hout'] = ("%4.2f" % (pyo.value(m.fs.fwh6_mix.outlet.enth_mol[0])))
    tags['fwh6mix_xout'] = ("%4.4f" % (pyo.value(m.fs.fwh6_mix.mixed_state[0].vapor_frac)))

    tags['fwh7mix_steam_Fin'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.steam.flow_mol[0])*1e-3))
    tags['fwh7mix_steam_Tin'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.steam_state[0].temperature)))
    tags['fwh7mix_steam_Pin'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.steam.pressure[0])*1e-6))
    tags['fwh7mix_steam_Hin'] = ("%4.2f" % (pyo.value(m.fs.fwh7_mix.steam.enth_mol[0])))
    tags['fwh7mix_steam_xin'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.steam_state[0].vapor_frac)))
    tags['fwh7mix_Fout'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.outlet.flow_mol[0])*1e-3))
    tags['fwh7mix_Tout'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.mixed_state[0].temperature)))
    tags['fwh7mix_Pout'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.outlet.pressure[0])*1e-6))
    tags['fwh7mix_Hout'] = ("%4.2f" % (pyo.value(m.fs.fwh7_mix.outlet.enth_mol[0])))
    tags['fwh7mix_xout'] = ("%4.4f" % (pyo.value(m.fs.fwh7_mix.mixed_state[0].vapor_frac)))

    tags['condmix_mu_Fin'] = ("%4.4f" % (pyo.value(m.fs.condenser_mix.makeup.flow_mol[0])*1e-3))
    tags['condmix_mu_Tin'] = ("%4.4f" % (pyo.value(m.fs.condenser_mix.makeup_state[0].temperature)))
    tags['condmix_mu_Pin'] = ("%4.4f" % (pyo.value(m.fs.condenser_mix.makeup.pressure[0])*1e-6))
    tags['condmix_mu_Hin'] = ("%4.2f" % (pyo.value(m.fs.condenser_mix.makeup.enth_mol[0])))
    tags['condmix_mu_xin'] = ("%4.4f" % (pyo.value(m.fs.condenser_mix.makeup_state[0].vapor_frac)))
    
    ## Deareator
    tags['da_steam_Fin'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.steam.flow_mol[0])*1e-3))
    tags['da_steam_Tin'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.steam_state[0].temperature)))
    tags['da_steam_Pin'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.steam.pressure[0])*1e-6))
    tags['da_steam_Hin'] = ("%4.2f" % (pyo.value(m.fs.fwh5_da.steam.enth_mol[0])))
    tags['da_steam_xin'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.steam_state[0].vapor_frac)))
    tags['da_Fout'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.outlet.flow_mol[0])*1e-3))
    tags['da_Tout'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.mixed_state[0].temperature)))
    tags['da_Pout'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.outlet.pressure[0])*1e-6))
    tags['da_Hout'] = ("%4.2f" % (pyo.value(m.fs.fwh5_da.outlet.enth_mol[0])))
    tags['da_xout'] = ("%4.4f" % (pyo.value(m.fs.fwh5_da.mixed_state[0].vapor_frac)))

    # BFP
    tags['bfp_Fout'] = ("%4.4f" % (pyo.value(m.fs.bfp.outlet.flow_mol[0])*1e-3))
    tags['bfp_Tout'] = ("%4.4f" % (pyo.value(m.fs.bfp.control_volume.properties_out[0].temperature)))
    tags['bfp_Pout'] = ("%4.4f" % (pyo.value(m.fs.bfp.outlet.pressure[0])*1e-6))
    tags['bfp_Hout'] = ("%4.2f" % (pyo.value(m.fs.bfp.outlet.enth_mol[0])))
    tags['bfp_xout'] = ("%4.4f" % (pyo.value(m.fs.bfp.control_volume.properties_out[0].vapor_frac)))
